...
public class Your_Events_Page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_your_events_page);
        ...
        DatabaseReference mRef =  database.getReference().child("Users").child(userId).child("Events");
    ...
    public void createPanel(String eventname, String eventdate, String eventkey){
        LinearLayout main = findViewById(R.id.yEvents);
        ...
        shape.setColor(Color.rgb(119, 255, 51));
        ...
        // Register Button
        Button unregister = new Button(this);
        unregister.setText("Unregister");
        unregister.setPadding(20, 10, 20, 10);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.profile:
                startActivity(new Intent(Your_Events_Page.this, Profile_Page.class));
                finish();
                return true;

            case R.id.events:
                startActivity(new Intent(Your_Events_Page.this, Events_Page.class));
                finish();
                return true;

            case R.id.yourevents:
                startActivity(new Intent(Your_Events_Page.this, Your_Events_Page.class));
                finish();
                return true;

            case R.id.aboutus:
                startActivity(new Intent(Your_Events_Page.this, About_Us_Page.class));
                finish();
                return true;

            case R.id.logout:
                FirebaseAuth.getInstance().signOut();
                startActivity(new Intent(Your_Events_Page.this, Login_Page.class));
                finish();
                return true;
            default:
